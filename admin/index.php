                    ...
                    <form action="login.php" method="POST" class="w-full">
                        <div>
                            ...
                            <div class="space-y-2 pb-2 w-full">
                                ...
                                <input type="text" id="myInput"  placeholder="enter your username" name="username" class="border border-gray-100 focus:border-gray-300 focus:outline-none py-1.5 px-2 text-gray-500 w-full" autocomplete="off">
                            </div>
                            <div class="space-y-2 pb-2 w-full">
                                <p class="text-gray-800">Password</p>
                                <input type="password" placeholder="enter your password" name="password" class="border border-gray-100 focus:border-gray-300 focus:outline-none py-1.5 px-2 text-gray-500 w-full" autocomplete="off">
                            </div>
