    ...
    <!-- start -->  
        <div class="flex justify-between items-center pb-2">
            <h1 class="font-medium text-gray-700  " styke="top:40px">User <span class="text-yellow-400">Logs</span></h1>
              <a href="process.php?clear" name="clear" class="relative bg-red-300 text-white rounded hover:bg-red-400 px-2 py-1 transition-all" onclick="this.classList.toggle('button--loading')">
