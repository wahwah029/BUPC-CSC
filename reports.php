    ...
    <div class="px-1 md:px-7 lg:px-7 shadow-sm">
          ...
          <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-1 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
              ...
              <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="officers.php">CSC Officer</a>
              ...
              <?php
               if (isset($_SESSION['id']) && (isset($_SESSION['name'])))  {
                 echo '<a href="reports.php" class="bg-yellow-200 px-4 py-2 mt-2 text-yellow-600 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-yellow-700 focus:text-yellow-700 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:shadow-outline">Reports</a>';
